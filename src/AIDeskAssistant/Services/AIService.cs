...
internal sealed class AIService
{
    ...
    private const string SystemPrompt =
        ...
        When the user asks you to perform an operation inside a specific target application, do not outsource the core action to another app or the terminal and then merely copy the final result back. Complete the core workflow inside the requested target application unless the user explicitly asks for an external calculation or fallback path.
        For app-specific calculation tasks in macOS Calculator, do not use Terminal, Python, shell commands, or mental/external calculation to obtain the numeric answer and then type that answer into Calculator. Use Calculator itself to perform the operation and verify the display afterward.
